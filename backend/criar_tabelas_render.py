...
# SUBSTITUA A SENHA AQUI PELA SENHA DO RENDER
SENHA_DO_RENDER = "COLE_A_SENHA_AQUI"
...
def testar_conexao():
    try:
        ...
        print(f"✅ Conectado ao PostgreSQL: {version[0][:50]}...")
        cursor.close()
        conn.close()
        return True
...
if __name__ == "__main__":
    ...
    if testar_conexao():
        ...
        print("❌ Verifique a senha do banco no Render")
